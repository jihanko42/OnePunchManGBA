...
SOURCES            = main.c game.c myLib.c start.c pause.c instruction.c spritesheet.c levelOne.c levelOneBG.c levelOneCollision.c levelTwo.c levelTwoBG.c levelTwoCollision.c levelThree.c levelThreeBG.c levelThreeCollision.c win.c lose.c sound.c gameSong.c startSong.c winSong.c loseSong.c intro01.c intro02.c intro03.c intro04.c introSong.c growlFX.c
