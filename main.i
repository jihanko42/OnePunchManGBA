...
# 1 "lose.h" 1
# 22 "lose.h"
extern const unsigned short loseTiles[2864];
...
# 1 "intro01.h" 1
# 22 "intro01.h"
extern const unsigned short intro01Tiles[6608];


extern const unsigned short intro01Map[1024];


extern const unsigned short intro01Pal[256];
# 19 "main.c" 2
# 1 "intro02.h" 1
# 22 "intro02.h"
extern const unsigned short intro02Tiles[6608];


extern const unsigned short intro02Map[1024];


extern const unsigned short intro02Pal[256];
# 20 "main.c" 2
# 1 "intro03.h" 1
# 22 "intro03.h"
extern const unsigned short intro03Tiles[6224];


extern const unsigned short intro03Map[1024];


extern const unsigned short intro03Pal[256];
# 21 "main.c" 2
# 1 "intro04.h" 1
# 22 "intro04.h"
extern const unsigned short intro04Tiles[8064];


extern const unsigned short intro04Map[1024];


extern const unsigned short intro04Pal[256];
# 22 "main.c" 2
# 1 "growlFX.h" 1
# 20 "growlFX.h"
...
void introAnimation() {
    switch(intro) {
        case 1:
            DMANow(3, intro01Pal, ((unsigned short *)0x5000000), 256);
            ...
            DMANow(3, intro01Tiles, &((charblock *)0x6000000)[0], 13216/2);
            DMANow(3, intro01Map, &((screenblock *)0x6000000)[31], 2048/2);

            if (introCounter < 0x80) {
                *(unsigned short*)0x4000050 = (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4) | (1 << 6) | (1 << 7);

                *(unsigned short*)0x4000054 = ((0x80 - introCounter) / 8);
            } else if (introCounter + 0x80 >= 2500) {
                *(unsigned short*)0x4000050 = (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4) | (1 << 6) | (1 << 7);

                *(unsigned short*)0x4000054 = ((introCounter) / 8);
            }
        ...
        case 2:
            DMANow(3, intro02Pal, ((unsigned short *)0x5000000), 256);
            if (introCounter == 0x80) {
                playSoundB(growlFX, 47808, 11025, 0);
            }
            ...
            DMANow(3, intro02Tiles, &((charblock *)0x6000000)[0], 13216/2);
            DMANow(3, intro02Map, &((screenblock *)0x6000000)[31], 2048/2);
        ...
        case 3:
            DMANow(3, intro03Pal, ((unsigned short *)0x5000000), 256);
            ...
            DMANow(3, intro03Tiles, &((charblock *)0x6000000)[0], 12448/2);
            DMANow(3, intro03Map, &((screenblock *)0x6000000)[31], 2048/2);
        ...
        case 4:
            DMANow(3, intro04Pal, ((unsigned short *)0x5000000), 256);
            ...
            DMANow(3, intro04Tiles, &((charblock *)0x6000000)[0], 16128/2);
            DMANow(3, intro04Map, &((screenblock *)0x6000000)[31], 2048/2);
        ...
        case 5:
            ...
            *(unsigned short*)0x4000054 = 0;
            goToStart();
            stopSound();
            playSoundA(startSong, 1428115, 11025, 1);
    }
...
void initialize() {
    ...
    state = INTRO;
    playSoundA(introSong, 262824, 11025, 0);
...
void start() {
    ...
    if ((!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
        playSoundA(gameSong, 959904, 11025, 1);
        currentLevel = 1;
        goToGame();
        initGame();
    }
...
void goToStart() {
    ...
    DMANow(3, startTiles, &((charblock *)0x6000000)[0], 9760/2);
...
void goToInstruction() {
    ...
    DMANow(3, instructionTiles, &((charblock *)0x6000000)[0], 9152/2);
...
void game() {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<0))) && (~((*(volatile unsigned short *)0x04000130)) & ((1<<1))) && (~((*(volatile unsigned short *)0x04000130)) & ((1<<2)))) {
        cheat = 1;
    }

    if ((player.worldCol + player.width + 15 >= 512) && enemiesRemaining <= 0) {
        switch(currentLevel) {
            case 1:
                currentLevel = 2;
                initGame();
...
void goToGame() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((1)<<2) | ((26)<<8) | (3<<14);
...
void goToWin() {
    ...
    DMANow(3, winTiles, &((charblock *)0x6000000)[0], 16992/2);
    ...
    stopSound();
    playSoundA(winSong, 5817769, 44100, 1);
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 5728/2);
    DMANow(3, loseMap, &((screenblock *)0x6000000)[31], 2048/2);

    stopSound();
    playSoundA(loseSong, 797075, 11025, 1);
